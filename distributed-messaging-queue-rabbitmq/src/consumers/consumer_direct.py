...
class DirectConsumer:
    """
    Consumer for direct exchange messages
    """
    
    def __init__(self):
        self.exchange = settings.EXCHANGE_DIRECT
        self.queue = settings.QUEUE_DIRECT
    ...
    def setup(self):
        ...
        logger.info(f"Direct consumer set up complete. Exchange: {self.exchange}, Queue: {self.queue}")
    ...
    def process_message(self, message_body):
        ...
        try:
            ...
            logger.info(f"Processing direct message: {data}")
    ...
    def handle_message(self, channel, method, properties, body):
        ...
        try:
            ...
            logger.info(f"Received message {message_id} from direct exchange")
    ...
    def start_consuming(self):
        ...
        try:
            ...
            logger.info(f"Starting to consume messages from {self.queue}")
